// $Id: spr_transform.C,v 1.3 2008-01-03 20:51:58 narsky Exp $
//
...
/*
  ...
  The following shows how to apply a sequence of PCA+Normalize
  transformations to these data.
*/
...
int spr_transform_1()
{
  ...
  // perform PCA
  int verbose = 0;
  spr.trainVarTransformer("PCA,Normalize",verbose);
  spr.transform();
  ...
  spr.saveVarTransformer("pca_norm.spr");
